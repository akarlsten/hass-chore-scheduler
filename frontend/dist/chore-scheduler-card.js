...
`,Fn=Vt.span`
  ...
  ${e=>e.$isCompleted&&Ut`
    ...
    color: var(--secondary-text-color);
  `}
`,jn=({title:e,items:t,choresById:n,sectionClass:r})=>i(Mn,{children:[i(zn,{$isOverdue:"overdue"===r,children:e}),i(Ln,{children:t.map(e=>i($n,{item:e,chore:n.get(e.chore_id),sectionClass:r},e.uid))})]}),Mn=Vt.div`
  margin-bottom: 12px;
...
`,Zn=({todoItems:e,chores:t,config:n})=>{const o=fn(),a=(0,tn.Kr)(()=>new Map(t.map(e=>[e.id,e])),[t]),s=e.filter(e=>"needs_action"===e.status),c=e.filter(e=>"completed"===e.status).sort((e,t)=>{var n,r;return(null!==(n=t.completed_at)&&void 0!==n?n:"").localeCompare(null!==(r=e.completed_at)&&void 0!==r?r:"")}).slice(0,3);if(0===s.length&&0===c.length)return i(Hn,{});const l=(new Date).toISOString().split("T")[0],d=s.filter(e=>e.due&&e.due<l),u=s.filter(e=>!e.due||e.due===l),p=s.filter(e=>e.due&&e.due>l);return 0===s.length&&c.length>0?i(Qn,{children:[i(Jn,{}),i(tr,{}),n.show_completed&&i(jn,{title:o("display.done"),items:c,choresById:a,sectionClass:"completed"})]}):i(Qn,{children:[i(er,{children:[d.length>0&&i(jn,{title:o("display.overdue"),items:d,choresById:a,sectionClass:"overdue"}),u.length>0&&i(jn,{title:o("display.today"),items:u,choresById:a,sectionClass:"today"}),p.length>0&&i(jn,{title:o("display.upcoming"),items:p,choresById:a,sectionClass:"upcoming"})]}),n.show_completed&&c.length>0&&i(r.FK,{children:[i(tr,{}),i(jn,{title:o("display.done"),items:c,choresById:a,sectionClass:"completed"})]})]})},Qn=Vt.div`
  display: flex;
  flex-direction: column;
  flex: 1;
  min-height: 0;
...
`,Ir=Vt.div`
  ...
  ${e=>e.$selected&&Ut`
    ...
    color: white;
  `}
`;function Pr(e){const t=["th","st","nd","rd"],n=e%100;return e+(t[(n-20)%10]||t[n]||t[0])}const $r=({scheduleType:e,scheduleDays:t,onDaysChange:n,scheduleDayOfMonth:r,onDayOfMonthChange:o,scheduleDate:a,onDateChange:s})=>"once"===e?i(Ar,{children:[i(Or,{children:"On date"}),i("ha-textfield",{type:"date",value:a,onInput:e=>s(e.target.value)})]}):"weekly"===e?i(Ar,{children:[i(Or,{children:"On days"}),i(Cr,{selectedDays:t,onChange:n})]}):"monthly"===e?i(Ar,{children:i(kr,{value:String(r),label:"On day",fixedMenuPosition:!0,onSelected:e=>o(parseInt(e)||1),children:Array.from({length:31},(e,t)=>t+1).map(e=>i("ha-list-item",{value:String(e),children:Pr(e)},e))})}):null,Ar=Vt.div`
  margin-top: 12px;
`,Or=Vt.label`
  display: block;
  font-size: 0.825rem;
...
`,Jr=Vt.label`
  ...
  color: var(--secondary-text-color);
  margin-bottom: 6px;
`,Vr=({chore:e,onSave:t,onDelete:n,onTrigger:r,onClose:o})=>{var a;cn();const s=fn(),c=(0,tn.li)(null),[l,d]=(0,tn.J0)(!1),u=!e,[p,f]=(0,tn.J0)((null==e?void 0:e.name)||""),[h,_]=(0,tn.J0)((null==e?void 0:e.description)||""),[m,g]=(0,tn.J0)((null==e?void 0:e.schedule.type)||"weekly"),[v,y]=(0,tn.J0)((null==e?void 0:e.schedule.days)||["sunday"]),[b,x]=(0,tn.J0)((null==e?void 0:e.schedule.time)||"10:00"),[w,k]=(0,tn.J0)((null==e?void 0:e.schedule.day_of_month)||1),[S,C]=(0,tn.J0)((null==e?void 0:e.schedule.date)||(new Date).toISOString().split("T")[0]),E="unassigned"!==(null==e?void 0:e.assignment.mode)&&(null===(a=null==e?void 0:e.assignment.assignees)||void 0===a?void 0:a.length)?e.assignment.assignees[0]:null,[I,P]=(0,tn.J0)(E),$=((null==e?void 0:e.notifications.notify_targets)||[]).filter(e=>"persistent_notification"!==e),A=((null==e?void 0:e.notifications.notify_targets)||[]).includes("persistent_notification"),[O,N]=(0,tn.J0)((null==e?void 0:e.notifications.enabled)||!1),[D,T]=(0,tn.J0)($),[R,F]=(0,tn.J0)(A),j=(0,tn.hb)(()=>{if(l)return;d(!0);const e=c.current,t=()=>o();e&&!window.matchMedia("(prefers-reduced-motion: reduce)").matches?(e.addEventListener("animationend",n=>{n.target===e&&t()},{once:!0}),setTimeout(t,300)):t()},[l,o]);return i(Xr,{ref:c,$closing:l,onClick:j,children:i(Zr,{$closing:l,onClick:e=>e.stopPropagation(),children:[i(Qr,{children:i("h2",{children:s(u?"editor.add_title":"editor.edit_title")})}),i(eo,{children:[i(to,{children:[i(no,{class:"required",children:s("editor.name")}),i("ha-textfield",{value:p,onInput:e=>f(e.target.value),placeholder:"e.g. Vacuum the floors"})]}),i(to,{children:[i(no,{children:s("assignment.title")}),i(hr,{selectedAssignee:I,onSelect:P})]}),i(to,{children:[i(no,{children:s("schedule.title")}),i(br,{scheduleType:m,onSelect:g}),i(ro,{children:[i(no,{children:s("schedule.time")}),i("ha-textfield",{type:"time",value:b,onInput:e=>x(e.target.value)})]}),i($r,{scheduleType:m,scheduleDays:v,onDaysChange:y,scheduleDayOfMonth:w,onDayOfMonthChange:k,scheduleDate:S,onDateChange:C})]}),i(oo,{}),i(to,{children:[i(no,{children:s("editor.description")}),i("ha-textfield",{value:h,onInput:e=>_(e.target.value),placeholder:"Notes or instructions..."})]}),i(Tr,{enabled:O,onEnabledChange:N,notifyTargets:D,onNotifyTargetsChange:T,persistentNotification:R,onPersistentChange:F})]}),i(io,{children:[!u&&i(so,{onClick:()=>{e&&confirm(s("editor.delete_confirm"))&&n(e.id)},children:s("editor.delete")}),!u&&i(uo,{onClick:()=>{e&&(r(e.id),j())},children:[i("ha-icon",{icon:"mdi:play"}),s("editor.trigger")]}),i(po,{}),i(co,{onClick:j,children:s("editor.cancel")}),i(lo,{onClick:()=>{const n={type:m,time:b,interval:1};"once"===m?n.date=S:"weekly"===m?n.days=v:"monthly"===m&&(n.day_of_month=w);const r={mode:I?"fixed":"unassigned",assignees:I?[I]:[],current_index:0},o=[...D];R&&o.push("persistent_notification");const i={enabled:O,remind_before:60,notify_targets:o},a={name:p.trim(),description:h.trim(),enabled:!0,schedule:n,assignment:r,notifications:i};e&&(a.id=e.id),t(a,u)},disabled:!p.trim(),children:s(u?"editor.add":"editor.save")})]})]})})},Kr=Kt`
  from { opacity: 0; }
  to { opacity: 1; }
`,Gr=Kt`
  from { opacity: 1; }
