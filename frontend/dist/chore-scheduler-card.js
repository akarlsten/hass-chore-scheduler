...
`,Pn=({item:e,chore:t,sectionClass:n})=>{const r=cn(),{completeItem:o}=fn(),a=an(e=>e.completingItems),s=(0,Kt.li)(null),c=wn(t?t.name:e.summary),l="completed"===e.status,d=!!a[e.uid],u=function(e){const t=e.match(/\(([^)]+)\)$/);return t?t[1]:null}(e.summary),p=e.completion_stats,f=!1!==(null==r?void 0:r.enable_animations);return i(On,{ref:s,$isCompleted:l,$isOverdue:"overdue"===n,$completing:d,children:[i(Nn,{$isCompleted:l,$completing:d,onClick:()=>{l||d||(f&&(window.matchMedia("(prefers-reduced-motion: reduce)").matches||"vibrate"in navigator&&navigator.vibrate([50,30,80])),o(e.uid))},children:i("ha-icon",{icon:l||d?"mdi:checkbox-marked-circle":"mdi:checkbox-blank-circle-outline"})}),i(Dn,{children:i("ha-icon",{icon:c})}),i(Tn,{children:i(Rn,{$isCompleted:l||d,children:e.summary})}),p&&i(En,{streak:p.streak}),u&&i(kn,{name:u})]})},$n=Gt`
  0% { transform: scale(1); }
...
`,On=Vt.div`
  ...
  ${e=>e.$completing&&Ut`
    animation: ${An} 0.45s ease-out 0.28s forwards;
    overflow: hidden;
    pointer-events: none;
...
`,Rn=Vt.span`
  ...
  ${e=>e.$isCompleted&&Ut`
    ...
    color: var(--secondary-text-color);
  `}
`,Fn=({title:e,items:t,chores:n,sectionClass:r})=>i(jn,{children:[i(Mn,{$isOverdue:"overdue"===r,children:e}),i(zn,{children:t.map(e=>i(Pn,{item:e,chore:n.find(t=>t.id===e.chore_id),sectionClass:r},e.uid))})]}),jn=Vt.div`
  margin-bottom: 12px;
...
`,Un=Vt.p`
  margin: 0;
`,Bn=()=>{const e=pn();return i(Kn,{children:[i(Yn,{children:i("ha-icon",{icon:"mdi:check-circle"})}),i(qn,{children:e("display.all_done")})]})},Jn=Gt`
...
`,qn=Vt.p`
  ...
  color: var(--primary-text-color);
  margin: 0;
  animation: ${Gn} 0.35s ease-out 0.25s both;

  @media (prefers-reduced-motion: reduce) {
    animation: none;
  }
`,Xn=({todoItems:e,chores:t,config:n})=>{const o=pn(),a=e.filter(e=>"needs_action"===e.status),s=e.filter(e=>"completed"===e.status).sort((e,t)=>{var n,r;return(null!==(n=t.completed_at)&&void 0!==n?n:"").localeCompare(null!==(r=e.completed_at)&&void 0!==r?r:"")}).slice(0,3);if(0===a.length&&0===s.length)return i(Ln,{});const c=(new Date).toISOString().split("T")[0],l=a.filter(e=>e.due&&e.due<c),d=a.filter(e=>!e.due||e.due===c),u=a.filter(e=>e.due&&e.due>c);return 0===a.length&&s.length>0?i(Zn,{children:[i(Bn,{}),i(er,{}),n.show_completed&&i(Fn,{title:o("display.done"),items:s,chores:t,sectionClass:"completed"})]}):i(Zn,{children:[i(Qn,{children:[l.length>0&&i(Fn,{title:o("display.overdue"),items:l,chores:t,sectionClass:"overdue"}),d.length>0&&i(Fn,{title:o("display.today"),items:d,chores:t,sectionClass:"today"}),u.length>0&&i(Fn,{title:o("display.upcoming"),items:u,chores:t,sectionClass:"upcoming"})]}),n.show_completed&&s.length>0&&i(r.FK,{children:[i(er,{}),i(Fn,{title:o("display.done"),items:s,chores:t,sectionClass:"completed"})]})]})},Zn=Vt.div`
  display: flex;
  flex-direction: column;
  flex: 1;
  min-height: 0;
`,Qn=Vt.div``,er=Vt.div`
  flex: 1;
  min-height: 16px;
`,tr=({type:e,text:t})=>i(nr,{$type:e,children:t}),nr=Vt.span`
  display: inline-flex;
  align-items: center;
  padding: 2px 8px;
  border-radius: 12px;
...
`,rr=({chore:e,todoItems:t,onEdit:n})=>{const r=sn(),o=wn(e.name),a=function(e,t){const n=e.time||"10:00";switch(e.type){case"once":{const r=e.date;return r?`${new Date(r+"T00:00:00").toLocaleDateString((null==t?void 0:t.language)||"en",{month:"short",day:"numeric"})} ${n}`:dn("display.at_time",t,{time:n})}case"daily":return dn("display.daily_at",t,{time:n});case"weekly":{const r=(e.days||["sunday"]).map(e=>un(e,t)).join(", ");return`${r} ${n}`}case"monthly":return dn("display.monthly_at",t,{day:e.day_of_month||1,time:n});default:return dn("display.at_time",t,{time:n})}}(e.schedule,r),s=function(e){var t;return"unassigned"!==e.assignment.mode&&(null===(t=e.assignment.assignees)||void 0===t?void 0:t.length)?e.assignment.assignees.filter(e=>null!=e).map(e=>{var t;return(null===(t=e.split(".").pop())||void 0===t?void 0:t.replace(/_/g," "))||e}):[]}(e),c=function(e,t){const n=t.find(t=>t.chore_id===e);return null==n?void 0:n.completion_stats}(e.id,t);return i(or,{$disabled:!e.enabled,onClick:()=>n(e),children:[i(ir,{children:i("ha-icon",{icon:o})}),i(ar,{children:[i(sr,{children:e.name}),i(cr,{children:[i(tr,{type:e.schedule.type,text:a}),s.map(e=>i(kn,{name:e},e)),c&&i(En,{streak:c.streak})]})]}),i(ir,{style:{marginRight:0,marginLeft:8},children:i("ha-icon",{icon:"mdi:chevron-right"})})]})},or=Vt.div`
  display: flex;
  align-items: center;
  padding: 12px;
...
`,cr=Vt.div`
  ...
  margin-top: 4px;
  flex-wrap: wrap;
`,lr=({chores:e,todoItems:t,config:n,onEditChore:r})=>{const o=pn(),a=n.show_disabled?e:e.filter(e=>e.enabled);return 0===a.length?i(ur,{children:[i("ha-icon",{icon:"mdi:broom"}),i("p",{children:o("card.empty_title")}),i("p",{children:o("card.empty_subtitle")})]}):i(dr,{children:a.map(e=>i(rr,{chore:e,todoItems:t,onEdit:r},e.id))})},dr=Vt.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
`,ur=Vt.div`
...
`,pr=({person:e,isSelected:t,onSelect:n})=>{const r=(e.attributes.friendly_name||e.entity_id.split(".")[1].replace(/_/g," ")).split(" ")[0],o=e.attributes.entity_picture;return i(_r,{$selected:t,onClick:n,children:[i(mr,{children:o?i("img",{src:o,alt:r,style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}):i("ha-icon",{icon:"mdi:account"})}),i(gr,{$selected:t,children:r})]})},fr=({selectedAssignee:e,onSelect:t})=>{const n=sn(),r=Object.values((null==n?void 0:n.states)||{}).filter(e=>e.entity_id.startsWith("person."));return i(hr,{children:[i(_r,{$selected:null===e,onClick:()=>t(null),children:[i(mr,{children:i("ha-icon",{icon:"mdi:account-group"})}),i(gr,{children:"Anyone"})]}),r.map(n=>i(pr,{person:n,isSelected:e===n.entity_id,onSelect:()=>t(n.entity_id)},n.entity_id))]})},hr=Vt.div`
  display: grid;
...
`,gr=Vt.span`
  ...
  ${e=>e.$selected&&Ut`
    ...
    color: var(--primary-color);
  `}
`,vr=[{type:"once",icon:"mdi:numeric-1-circle",labelKey:"schedule.once"},{type:"daily",icon:"mdi:calendar-today",labelKey:"schedule.daily"},{type:"weekly",icon:"mdi:calendar-week",labelKey:"schedule.weekly"},{type:"monthly",icon:"mdi:calendar-month",labelKey:"schedule.monthly"}],yr=({scheduleType:e,onSelect:t})=>{const n=pn();return i(br,{children:vr.map(({type:r,icon:o,labelKey:a})=>i(xr,{$selected:e===r,onClick:()=>t(r),children:[i("ha-icon",{icon:o}),i("span",{children:n(a)})]},r))})},br=Vt.div`
  display: grid;
...
`,Er=Vt.div`
  ...
  ${e=>e.$selected&&Ut`
    ...
    color: white;
  `}
`;function Ir(e){const t=["th","st","nd","rd"],n=e%100;return e+(t[(n-20)%10]||t[n]||t[0])}const Pr=({scheduleType:e,scheduleDays:t,onDaysChange:n,scheduleDayOfMonth:r,onDayOfMonthChange:o,scheduleDate:a,onDateChange:s})=>"once"===e?i($r,{children:[i(Ar,{children:"On date"}),i("ha-textfield",{type:"date",value:a,onInput:e=>s(e.target.value)})]}):"weekly"===e?i($r,{children:[i(Ar,{children:"On days"}),i(Sr,{selectedDays:t,onChange:n})]}):"monthly"===e?i($r,{children:i(wr,{value:String(r),label:"On day",fixedMenuPosition:!0,onSelected:e=>o(parseInt(e)||1),children:Array.from({length:31},(e,t)=>t+1).map(e=>i("ha-list-item",{value:String(e),children:Ir(e)},e))})}):null,$r=Vt.div`
  margin-top: 12px;
`,Ar=Vt.label`
  display: block;
  font-size: 0.825rem;
  ...
  color: var(--secondary-text-color);
  margin-bottom: 8px;
`,Or=({checked:e,onChange:t})=>{const n=(0,Kt.li)(null);(0,Kt.vJ)(()=>{n.current&&(n.current.checked=e)},[e]);const r=(0,Kt.hb)(e=>{e.stopPropagation(),t(e.target.checked)},[t]);return(0,Kt.vJ)(()=>{const e=n.current;if(e)return e.addEventListener("change",r),()=>e.removeEventListener("change",r)},[r]),i("ha-switch",{ref:n})},Nr=({checked:e,onClick:t})=>{const n=(0,Kt.li)(null);return(0,Kt.vJ)(()=>{n.current&&(n.current.checked=e)},[e]),i("ha-checkbox",{ref:n,onClick:t})},Dr=({enabled:e,onEnabledChange:t,notifyTargets:n,onNotifyTargetsChange:r,persistentNotification:o,onPersistentChange:a})=>{const s=sn(),c=pn(),l=function(e){const t=e.notify;return t?Object.keys(t).filter(e=>e.startsWith("mobile_app_")).map(e=>({service:`notify.${e}`,name:e.replace("mobile_app_","").replace(/_/g," ")})):[]}((null==s?void 0:s.services)||{});return i(Tr,{children:[i(Rr,{onClick:()=>t(!e),children:[i("div",{children:[i(Fr,{children:c("notifications.title")}),i(jr,{children:"Get reminded when due"})]}),i(Or,{checked:e,onChange:e=>{t(e)}})]}),e&&i(Mr,{children:[i(zr,{$selected:o,onClick:()=>a(!o),children:[i("ha-icon",{icon:"mdi:bell-badge"}),i(Lr,{children:[i(Hr,{children:"Persistent notification"}),i(Wr,{children:"Shows in HA sidebar until dismissed"})]}),i(Nr,{checked:o,onClick:e=>e.stopPropagation()})]}),l.length>0&&i(Ur,{children:[i(Br,{children:"Mobile devices"}),l.map(e=>i(zr,{$selected:n.includes(e.service),onClick:()=>{return t=e.service,void(n.includes(t)?r(n.filter(e=>e!==t)):r([...n,t]));var t},children:[i("ha-icon",{icon:"mdi:cellphone"}),i(Lr,{children:i(Hr,{children:e.name})}),i(Nr,{checked:n.includes(e.service),onClick:e=>e.stopPropagation()})]},e.service))]})]})]})},Tr=Vt.div`
  background: var(--secondary-background-color);
  border-radius: 10px;
  padding: 12px;
`,Rr=Vt.div`
...
`,Br=Vt.label`
  ...
  color: var(--secondary-text-color);
  margin-bottom: 6px;
`,Jr=({chore:e,onSave:t,onDelete:n,onTrigger:r,onClose:o})=>{var a;sn();const s=pn(),c=(0,Kt.li)(null),[l,d]=(0,Kt.J0)(!1),u=!e,[p,f]=(0,Kt.J0)((null==e?void 0:e.name)||""),[h,_]=(0,Kt.J0)((null==e?void 0:e.description)||""),[m,g]=(0,Kt.J0)((null==e?void 0:e.schedule.type)||"weekly"),[v,y]=(0,Kt.J0)((null==e?void 0:e.schedule.days)||["sunday"]),[b,x]=(0,Kt.J0)((null==e?void 0:e.schedule.time)||"10:00"),[w,k]=(0,Kt.J0)((null==e?void 0:e.schedule.day_of_month)||1),[S,C]=(0,Kt.J0)((null==e?void 0:e.schedule.date)||(new Date).toISOString().split("T")[0]),E="unassigned"!==(null==e?void 0:e.assignment.mode)&&(null===(a=null==e?void 0:e.assignment.assignees)||void 0===a?void 0:a.length)?e.assignment.assignees[0]:null,[I,P]=(0,Kt.J0)(E),$=((null==e?void 0:e.notifications.notify_targets)||[]).filter(e=>"persistent_notification"!==e),A=((null==e?void 0:e.notifications.notify_targets)||[]).includes("persistent_notification"),[O,N]=(0,Kt.J0)((null==e?void 0:e.notifications.enabled)||!1),[D,T]=(0,Kt.J0)($),[R,F]=(0,Kt.J0)(A),j=(0,Kt.hb)(()=>{if(l)return;d(!0);const e=c.current,t=()=>o();e&&!window.matchMedia("(prefers-reduced-motion: reduce)").matches?(e.addEventListener("animationend",n=>{n.target===e&&t()},{once:!0}),setTimeout(t,300)):t()},[l,o]);return i(qr,{ref:c,$closing:l,onClick:j,children:i(Xr,{$closing:l,onClick:e=>e.stopPropagation(),children:[i(Zr,{children:i("h2",{children:s(u?"editor.add_title":"editor.edit_title")})}),i(Qr,{children:[i(eo,{children:[i(to,{class:"required",children:s("editor.name")}),i("ha-textfield",{value:p,onInput:e=>f(e.target.value),placeholder:"e.g. Vacuum the floors"})]}),i(eo,{children:[i(to,{children:s("assignment.title")}),i(fr,{selectedAssignee:I,onSelect:P})]}),i(eo,{children:[i(to,{children:s("schedule.title")}),i(yr,{scheduleType:m,onSelect:g}),i(no,{children:[i(to,{children:s("schedule.time")}),i("ha-textfield",{type:"time",value:b,onInput:e=>x(e.target.value)})]}),i(Pr,{scheduleType:m,scheduleDays:v,onDaysChange:y,scheduleDayOfMonth:w,onDayOfMonthChange:k,scheduleDate:S,onDateChange:C})]}),i(ro,{}),i(eo,{children:[i(to,{children:s("editor.description")}),i("ha-textfield",{value:h,onInput:e=>_(e.target.value),placeholder:"Notes or instructions..."})]}),i(Dr,{enabled:O,onEnabledChange:N,notifyTargets:D,onNotifyTargetsChange:T,persistentNotification:R,onPersistentChange:F})]}),i(oo,{children:[!u&&i(ao,{onClick:()=>{e&&confirm(s("editor.delete_confirm"))&&n(e.id)},children:s("editor.delete")}),!u&&i(lo,{onClick:()=>{e&&(r(e.id),j())},children:[i("ha-icon",{icon:"mdi:play"}),s("editor.trigger")]}),i(uo,{}),i(so,{onClick:j,children:s("editor.cancel")}),i(co,{onClick:()=>{const n={type:m,time:b,interval:1};"once"===m?n.date=S:"weekly"===m?n.days=v:"monthly"===m&&(n.day_of_month=w);const r={mode:I?"fixed":"unassigned",assignees:I?[I]:[],current_index:0},o=[...D];R&&o.push("persistent_notification");const i={enabled:O,remind_before:60,notify_targets:o},a={name:p.trim(),description:h.trim(),enabled:!0,schedule:n,assignment:r,notifications:i};e&&(a.id=e.id),t(a,u)},disabled:!p.trim(),children:s(u?"editor.add":"editor.save")})]})]})})},Vr=Gt`
  from { opacity: 0; }
  to { opacity: 1; }
`,Gr=Gt`
  from { opacity: 1; }
...
`,qr=Vt.div`
  ...
  ${e=>e.$closing&&Ut`
    animation: ${Gr} 0.2s ease-in forwards;
  `}
...
`,Xr=Vt.div`
  ...
  flex-direction: column;
  overflow: hidden;
  animation: ${Kr} 0.25s ease-out;

  ${e=>e.$closing&&Ut`
    animation: ${Yr} 0.2s ease-in forwards;
  `}
...
`,uo=Vt.div`
  flex: 1;
`,po=()=>{const e=an(),t=cn(),n=an()(e=>e.chores),r=an()(e=>e.todoItems),o=e(e=>e.loading),a=e(e=>e.mode),{setMode:s,saveChore:c,deleteChore:l,triggerChore:d,loadData:u}=fn(),[p,f]=(0,Kt.J0)(!1),[h,_]=(0,Kt.J0)(null);if(!t)return null;const m=()=>{f(!1),_(null)};return i(fo,{children:[i(hn,{title:t.title||"Chore Scheduler",mode:a,onToggleMode:()=>{s("display"===a?"manage":"display")},onAddChore:()=>{_(null),f(!0)}}),i(ho,{children:o?i(_o,{children:i("ha-circular-progress",{indeterminate:!0})}):"display"===a?i(Xn,{todoItems:r,chores:n,config:t}):i(lr,{chores:n,todoItems:r,config:t,onEditChore:e=>{_(e),f(!0)}})}),p&&i(Jr,{chore:h,onSave:async(e,t)=>{try{await c(e,t),m()}catch(e){console.error("[ChoreScheduler] Error saving chore:",e),alert(`Failed to save chore: ${e instanceof Error?e.message:String(e)}`)}},onDelete:async e=>{try{await l(e),m()}catch(e){console.error("[ChoreScheduler] Error deleting chore:",e)}},onTrigger:d,onClose:m})]})},fo=Vt.div`
  display: flex;
  flex-direction: column;
  flex: 1;
  min-height: 0;
...
`,_o=Vt.div`
  ...
  flex: 1;
  padding: 32px;
`,mo=({hass:e,config:t})=>{const n=an(),r=n(e=>e.setHass),o=n(e=>e.setConfig),a=n(e=>e.subscribe),s=n(e=>e.unsubscribe),c=n(e=>!!e.hass);return(0,Kt.vJ)(()=>{r(e)},[e]),(0,Kt.vJ)(()=>{o(t)},[t]),(0,Kt.vJ)(()=>{if(c)return a(),()=>s()},[c]),i(po,{})},go=({hass:e,config:t})=>i(on,{children:i(mo,{hass:e,config:t})}),vo=({hass:e,config:t,onConfigChanged:n})=>{const r=e=>{n(Object.assign(Object.assign({},t),e))};return i(yo,{children:[i(bo,{children:i("ha-textfield",{label:"Title",value:t.title||"Chore Scheduler",onInput:e=>r({title:e.target.value})})}),i(bo,{children:i(wr,{value:t.default_mode||"display",label:"Default mode",onSelected:e=>r({default_mode:e}),children:[i("ha-list-item",{value:"display",children:"Display (view todos)"}),i("ha-list-item",{value:"manage",children:"Manage (edit chores)"})]})}),i(xo,{children:[i(wo,{children:[i(ko,{children:"Show disabled chores"}),i(Or,{checked:!1!==t.show_disabled,onChange:e=>r({show_disabled:e})})]}),i(wo,{children:[i(ko,{children:"Show completed todos"}),i(Or,{checked:!0===t.show_completed,onChange:e=>r({show_completed:e})})]}),i(wo,{children:[i(ko,{children:"Enable animations"}),i(Or,{checked:!1!==t.enable_animations,onChange:e=>r({enable_animations:e})})]}),i(wo,{children:[i(ko,{children:"Expand to fill viewport"}),i(Or,{checked:!0===t.expand_to_viewport,onChange:e=>r({expand_to_viewport:e})})]})]})]})},yo=Vt.div``,bo=Vt.div`
  margin-bottom: 16px;
