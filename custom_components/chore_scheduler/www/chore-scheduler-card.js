...
`,Fn=Vt.span`
  ...
  ${e=>e.$isCompleted&&Ut`
    ...
    color: var(--secondary-text-color);
  `}
`,Mn=({title:e,items:t,chores:n,sectionClass:r})=>i(jn,{children:[i(zn,{$isOverdue:"overdue"===r,children:e}),i(Ln,{children:t.map(e=>i(An,{item:e,chore:n.find(t=>t.id===e.chore_id),sectionClass:r},e.uid))})]}),jn=Vt.div`
  margin-bottom: 12px;
...
`,Bn=Vt.p`
  margin: 0;
`,Jn=()=>{const e=fn();return i(Yn,{children:[i(qn,{children:i("ha-icon",{icon:"mdi:check-circle"})}),i(Xn,{children:e("display.all_done")})]})},Vn=Kt`
...
`,Zn=({todoItems:e,chores:t,config:n})=>{const o=fn(),a=e.filter(e=>"needs_action"===e.status),s=e.filter(e=>"completed"===e.status).sort((e,t)=>{var n,r;return(null!==(n=t.completed_at)&&void 0!==n?n:"").localeCompare(null!==(r=e.completed_at)&&void 0!==r?r:"")}).slice(0,3);if(0===a.length&&0===s.length)return i(Hn,{});const c=(new Date).toISOString().split("T")[0],l=a.filter(e=>e.due&&e.due<c),d=a.filter(e=>!e.due||e.due===c),u=a.filter(e=>e.due&&e.due>c);return 0===a.length&&s.length>0?i(r.FK,{children:[i(Jn,{}),n.show_completed&&i(Mn,{title:o("display.done"),items:s,chores:t,sectionClass:"completed"})]}):i(r.FK,{children:[l.length>0&&i(Mn,{title:o("display.overdue"),items:l,chores:t,sectionClass:"overdue"}),d.length>0&&i(Mn,{title:o("display.today"),items:d,chores:t,sectionClass:"today"}),u.length>0&&i(Mn,{title:o("display.upcoming"),items:u,chores:t,sectionClass:"upcoming"}),n.show_completed&&s.length>0&&i(Mn,{title:o("display.done"),items:s,chores:t,sectionClass:"completed"})]})},Qn=({type:e,text:t})=>i(er,{$type:e,children:t}),er=Vt.span`
  display: inline-flex;
  align-items: center;
  padding: 2px 8px;
  border-radius: 12px;
...
`,tr=({chore:e,todoItems:t,onEdit:n})=>{const r=cn(),o=kn(e.name),a=function(e,t){const n=e.time||"10:00";switch(e.type){case"once":{const r=e.date;return r?`${new Date(r+"T00:00:00").toLocaleDateString((null==t?void 0:t.language)||"en",{month:"short",day:"numeric"})} ${n}`:un("display.at_time",t,{time:n})}case"daily":return un("display.daily_at",t,{time:n});case"weekly":{const r=(e.days||["sunday"]).map(e=>pn(e,t)).join(", ");return`${r} ${n}`}case"monthly":return un("display.monthly_at",t,{day:e.day_of_month||1,time:n});default:return un("display.at_time",t,{time:n})}}(e.schedule,r),s=function(e){var t;return"unassigned"!==e.assignment.mode&&(null===(t=e.assignment.assignees)||void 0===t?void 0:t.length)?e.assignment.assignees.filter(e=>null!=e).map(e=>{var t;return(null===(t=e.split(".").pop())||void 0===t?void 0:t.replace(/_/g," "))||e}):[]}(e),c=function(e,t){const n=t.find(t=>t.chore_id===e);return null==n?void 0:n.completion_stats}(e.id,t);return i(nr,{$disabled:!e.enabled,onClick:()=>n(e),children:[i(rr,{children:i("ha-icon",{icon:o})}),i(or,{children:[i(ir,{children:e.name}),i(ar,{children:[i(Qn,{type:e.schedule.type,text:a}),s.map(e=>i(Sn,{name:e},e)),c&&i(In,{streak:c.streak})]})]}),i(rr,{style:{marginRight:0,marginLeft:8},children:i("ha-icon",{icon:"mdi:chevron-right"})})]})},nr=Vt.div`
  display: flex;
  align-items: center;
  padding: 12px;
...
`,ar=Vt.div`
  ...
  margin-top: 4px;
  flex-wrap: wrap;
`,sr=({chores:e,todoItems:t,config:n,onEditChore:r})=>{const o=fn(),a=n.show_disabled?e:e.filter(e=>e.enabled);return 0===a.length?i(lr,{children:[i("ha-icon",{icon:"mdi:broom"}),i("p",{children:o("card.empty_title")}),i("p",{children:o("card.empty_subtitle")})]}):i(cr,{children:a.map(e=>i(tr,{chore:e,todoItems:t,onEdit:r},e.id))})},cr=Vt.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
`,lr=Vt.div`
...
`,dr=({person:e,isSelected:t,onSelect:n})=>{const r=(e.attributes.friendly_name||e.entity_id.split(".")[1].replace(/_/g," ")).split(" ")[0],o=e.attributes.entity_picture;return i(fr,{$selected:t,onClick:n,children:[i(hr,{children:o?i("img",{src:o,alt:r,style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}):i("ha-icon",{icon:"mdi:account"})}),i(_r,{$selected:t,children:r})]})},ur=({selectedAssignee:e,onSelect:t})=>{const n=cn(),r=Object.values((null==n?void 0:n.states)||{}).filter(e=>e.entity_id.startsWith("person."));return i(pr,{children:[i(fr,{$selected:null===e,onClick:()=>t(null),children:[i(hr,{children:i("ha-icon",{icon:"mdi:account-group"})}),i(_r,{children:"Anyone"})]}),r.map(n=>i(dr,{person:n,isSelected:e===n.entity_id,onSelect:()=>t(n.entity_id)},n.entity_id))]})},pr=Vt.div`
  display: grid;
...
`,_r=Vt.span`
  ...
  ${e=>e.$selected&&Ut`
    ...
    color: var(--primary-color);
  `}
`,mr=[{type:"once",icon:"mdi:numeric-1-circle",labelKey:"schedule.once"},{type:"daily",icon:"mdi:calendar-today",labelKey:"schedule.daily"},{type:"weekly",icon:"mdi:calendar-week",labelKey:"schedule.weekly"},{type:"monthly",icon:"mdi:calendar-month",labelKey:"schedule.monthly"}],gr=({scheduleType:e,onSelect:t})=>{const n=fn();return i(vr,{children:mr.map(({type:r,icon:o,labelKey:a})=>i(yr,{$selected:e===r,onClick:()=>t(r),children:[i("ha-icon",{icon:o}),i("span",{children:n(a)})]},r))})},vr=Vt.div`
  display: grid;
...
`,yr=Vt.div`
  ...
  `}
`,br=({value:e,label:t,fixedMenuPosition:n,onSelected:r,children:o})=>{const a=(0,Gt.li)(null);(0,Gt.vJ)(()=>{a.current&&(a.current.value=e)},[e]);const s=(0,Gt.hb)(e=>{const t=e.detail;(null==t?void 0:t.value)&&r(t.value)},[r]),c=(0,Gt.hb)(e=>{e.stopPropagation()},[]);return(0,Gt.vJ)(()=>{const e=a.current;if(e)return e.addEventListener("selected",s),e.addEventListener("closed",c),()=>{e.removeEventListener("selected",s),e.removeEventListener("closed",c)}},[s,c]),i("ha-select",{ref:a,label:t,fixedMenuPosition:n,children:o})},wr=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"],xr=({selectedDays:e,onChange:t})=>{const n=cn();return i(kr,{children:wr.map(r=>i(Sr,{$selected:e.includes(r),onClick:()=>(n=>{e.includes(n)?e.length>1&&t(e.filter(e=>e!==n)):t([...e,n])})(r),children:pn(r,n)},r))})},kr=Vt.div`
  display: flex;
  gap: 4px;
  flex-wrap: wrap;
  margin-top: 12px;
`,Sr=Vt.div`
  ...
  ${e=>e.$selected&&Ut`
    ...
    color: white;
  `}
`;function Cr(e){const t=["th","st","nd","rd"],n=e%100;return e+(t[(n-20)%10]||t[n]||t[0])}const Er=({scheduleType:e,scheduleDays:t,onDaysChange:n,scheduleDayOfMonth:r,onDayOfMonthChange:o,scheduleDate:a,onDateChange:s})=>"once"===e?i(Ir,{children:[i(Pr,{children:"On date"}),i("ha-textfield",{type:"date",value:a,onInput:e=>s(e.target.value)})]}):"weekly"===e?i(Ir,{children:[i(Pr,{children:"On days"}),i(xr,{selectedDays:t,onChange:n})]}):"monthly"===e?i(Ir,{children:i(br,{value:String(r),label:"On day",fixedMenuPosition:!0,onSelected:e=>o(parseInt(e)||1),children:Array.from({length:31},(e,t)=>t+1).map(e=>i("ha-list-item",{value:String(e),children:Cr(e)},e))})}):null,Ir=Vt.div`
  margin-top: 12px;
`,Pr=Vt.label`
  display: block;
  font-size: 0.825rem;
  ...
  color: var(--secondary-text-color);
  margin-bottom: 8px;
`,Ar=({checked:e,onChange:t})=>{const n=(0,Gt.li)(null);(0,Gt.vJ)(()=>{n.current&&(n.current.checked=e)},[e]);const r=(0,Gt.hb)(e=>{e.stopPropagation(),t(e.target.checked)},[t]);return(0,Gt.vJ)(()=>{const e=n.current;if(e)return e.addEventListener("change",r),()=>e.removeEventListener("change",r)},[r]),i("ha-switch",{ref:n})},$r=({checked:e,onClick:t})=>{const n=(0,Gt.li)(null);return(0,Gt.vJ)(()=>{n.current&&(n.current.checked=e)},[e]),i("ha-checkbox",{ref:n,onClick:t})},Or=({enabled:e,onEnabledChange:t,notifyTargets:n,onNotifyTargetsChange:r,persistentNotification:o,onPersistentChange:a})=>{const s=cn(),c=fn(),l=function(e){const t=e.notify;return t?Object.keys(t).filter(e=>e.startsWith("mobile_app_")).map(e=>({service:`notify.${e}`,name:e.replace("mobile_app_","").replace(/_/g," ")})):[]}((null==s?void 0:s.services)||{});return i(Nr,{children:[i(Dr,{onClick:()=>t(!e),children:[i("div",{children:[i(Tr,{children:c("notifications.title")}),i(Rr,{children:"Get reminded when due"})]}),i(Ar,{checked:e,onChange:e=>{t(e)}})]}),e&&i(Fr,{children:[i(Mr,{$selected:o,onClick:()=>a(!o),children:[i("ha-icon",{icon:"mdi:bell-badge"}),i(jr,{children:[i(zr,{children:"Persistent notification"}),i(Lr,{children:"Shows in HA sidebar until dismissed"})]}),i($r,{checked:o,onClick:e=>e.stopPropagation()})]}),l.length>0&&i(Hr,{children:[i(Wr,{children:"Mobile devices"}),l.map(e=>i(Mr,{$selected:n.includes(e.service),onClick:()=>{return t=e.service,void(n.includes(t)?r(n.filter(e=>e!==t)):r([...n,t]));var t},children:[i("ha-icon",{icon:"mdi:cellphone"}),i(jr,{children:i(zr,{children:e.name})}),i($r,{checked:n.includes(e.service),onClick:e=>e.stopPropagation()})]},e.service))]})]})]})},Nr=Vt.div`
  background: var(--secondary-background-color);
  border-radius: 10px;
  padding: 12px;
`,Dr=Vt.div`
...
`,Wr=Vt.label`
  ...
  color: var(--secondary-text-color);
  margin-bottom: 6px;
`,Ur=({chore:e,onSave:t,onDelete:n,onTrigger:r,onClose:o})=>{var a;cn();const s=fn(),c=(0,Gt.li)(null),[l,d]=(0,Gt.J0)(!1),u=!e,[p,f]=(0,Gt.J0)((null==e?void 0:e.name)||""),[h,_]=(0,Gt.J0)((null==e?void 0:e.description)||""),[m,g]=(0,Gt.J0)((null==e?void 0:e.schedule.type)||"weekly"),[v,y]=(0,Gt.J0)((null==e?void 0:e.schedule.days)||["sunday"]),[b,w]=(0,Gt.J0)((null==e?void 0:e.schedule.time)||"10:00"),[x,k]=(0,Gt.J0)((null==e?void 0:e.schedule.day_of_month)||1),[S,C]=(0,Gt.J0)((null==e?void 0:e.schedule.date)||(new Date).toISOString().split("T")[0]),E="unassigned"!==(null==e?void 0:e.assignment.mode)&&(null===(a=null==e?void 0:e.assignment.assignees)||void 0===a?void 0:a.length)?e.assignment.assignees[0]:null,[I,P]=(0,Gt.J0)(E),A=((null==e?void 0:e.notifications.notify_targets)||[]).filter(e=>"persistent_notification"!==e),$=((null==e?void 0:e.notifications.notify_targets)||[]).includes("persistent_notification"),[O,N]=(0,Gt.J0)((null==e?void 0:e.notifications.enabled)||!1),[D,T]=(0,Gt.J0)(A),[R,F]=(0,Gt.J0)($),M=(0,Gt.hb)(()=>{if(l)return;d(!0);const e=c.current,t=()=>o();e&&!window.matchMedia("(prefers-reduced-motion: reduce)").matches?(e.addEventListener("animationend",n=>{n.target===e&&t()},{once:!0}),setTimeout(t,300)):t()},[l,o]);return i(Gr,{ref:c,$closing:l,onClick:M,children:i(Yr,{$closing:l,onClick:e=>e.stopPropagation(),children:[i(qr,{children:i("h2",{children:s(u?"editor.add_title":"editor.edit_title")})}),i(Xr,{children:[i(Zr,{children:[i(Qr,{class:"required",children:s("editor.name")}),i("ha-textfield",{value:p,onInput:e=>f(e.target.value),placeholder:"e.g. Vacuum the floors"})]}),i(Zr,{children:[i(Qr,{children:s("assignment.title")}),i(ur,{selectedAssignee:I,onSelect:P})]}),i(Zr,{children:[i(Qr,{children:s("schedule.title")}),i(gr,{scheduleType:m,onSelect:g}),i(eo,{children:[i(Qr,{children:s("schedule.time")}),i("ha-textfield",{type:"time",value:b,onInput:e=>w(e.target.value)})]}),i(Er,{scheduleType:m,scheduleDays:v,onDaysChange:y,scheduleDayOfMonth:x,onDayOfMonthChange:k,scheduleDate:S,onDateChange:C})]}),i(to,{}),i(Zr,{children:[i(Qr,{children:s("editor.description")}),i("ha-textfield",{value:h,onInput:e=>_(e.target.value),placeholder:"Notes or instructions..."})]}),i(Or,{enabled:O,onEnabledChange:N,notifyTargets:D,onNotifyTargetsChange:T,persistentNotification:R,onPersistentChange:F})]}),i(no,{children:[!u&&i(oo,{onClick:()=>{e&&confirm(s("editor.delete_confirm"))&&n(e.id)},children:s("editor.delete")}),!u&&i(so,{onClick:()=>{e&&(r(e.id),M())},children:[i("ha-icon",{icon:"mdi:play"}),s("editor.trigger")]}),i(co,{}),i(io,{onClick:M,children:s("editor.cancel")}),i(ao,{onClick:()=>{const n={type:m,time:b,interval:1};"once"===m?n.date=S:"weekly"===m?n.days=v:"monthly"===m&&(n.day_of_month=x);const r={mode:I?"fixed":"unassigned",assignees:I?[I]:[],current_index:0},o=[...D];R&&o.push("persistent_notification");const i={enabled:O,remind_before:60,notify_targets:o},a={name:p.trim(),description:h.trim(),enabled:!0,schedule:n,assignment:r,notifications:i};e&&(a.id=e.id),t(a,u)},disabled:!p.trim(),children:s(u?"editor.add":"editor.save")})]})]})})},Br=Kt`
  from { opacity: 0; }
  to { opacity: 1; }
`,Jr=Kt`
  from { opacity: 1; }
...
`,Gr=Vt.div`
  ...
  padding: 12px;
  box-sizing: border-box;
  animation: ${Br} 0.2s ease-out;

  ${e=>e.$closing&&Ut`
    animation: ${Jr} 0.2s ease-in forwards;
  `}
...
`,co=Vt.div`
  flex: 1;
`,lo=()=>{const e=sn(),t=ln(),n=sn()(e=>e.chores),r=sn()(e=>e.todoItems),o=e(e=>e.loading),a=e(e=>e.mode),{setMode:s,saveChore:c,deleteChore:l,triggerChore:d,loadData:u}=hn(),[p,f]=(0,Gt.J0)(!1),[h,_]=(0,Gt.J0)(null);if(!t)return null;const m=()=>{f(!1),_(null)};return i(uo,{children:[i(_n,{title:t.title||"Chore Scheduler",mode:a,onToggleMode:()=>{s("display"===a?"manage":"display")},onAddChore:()=>{_(null),f(!0)}}),o?i(po,{children:i("ha-circular-progress",{indeterminate:!0})}):"display"===a?i(Zn,{todoItems:r,chores:n,config:t}):i(sr,{chores:n,todoItems:r,config:t,onEditChore:e=>{_(e),f(!0)}}),p&&i(Ur,{chore:h,onSave:async(e,t)=>{try{await c(e,t),m()}catch(e){console.error("[ChoreScheduler] Error saving chore:",e),alert(`Failed to save chore: ${e instanceof Error?e.message:String(e)}`)}},onDelete:async e=>{try{await l(e),m()}catch(e){console.error("[ChoreScheduler] Error deleting chore:",e)}},onTrigger:d,onClose:m})]})},uo=Vt.div`
  padding: 16px;
`,po=Vt.div`
  display: flex;
  justify-content: center;
  padding: 32px;
`,fo=({hass:e,config:t})=>{const n=sn(),r=n(e=>e.setHass),o=n(e=>e.setConfig),a=n(e=>e.loadData),s=n(e=>!!e.hass);return(0,Gt.vJ)(()=>{r(e)},[e]),(0,Gt.vJ)(()=>{o(t)},[t]),(0,Gt.vJ)(()=>{s&&a()},[s]),i(lo,{})},ho=({hass:e,config:t})=>i(an,{children:i(fo,{hass:e,config:t})}),_o=({hass:e,config:t,onConfigChanged:n})=>{const r=e=>{n(Object.assign(Object.assign({},t),e))};return i(mo,{children:[i(go,{children:i("ha-textfield",{label:"Title",value:t.title||"Chore Scheduler",onInput:e=>r({title:e.target.value})})}),i(go,{children:i(br,{value:t.default_mode||"display",label:"Default mode",onSelected:e=>r({default_mode:e}),children:[i("ha-list-item",{value:"display",children:"Display (view todos)"}),i("ha-list-item",{value:"manage",children:"Manage (edit chores)"})]})}),i(vo,{children:[i(yo,{children:[i(bo,{children:"Show disabled chores"}),i(Ar,{checked:!1!==t.show_disabled,onChange:e=>r({show_disabled:e})})]}),i(yo,{children:[i(bo,{children:"Show completed todos"}),i(Ar,{checked:!0===t.show_completed,onChange:e=>r({show_completed:e})})]}),i(yo,{children:[i(bo,{children:"Enable animations"}),i(Ar,{checked:!1!==t.enable_animations,onChange:e=>r({enable_animations:e})})]})]})]})},mo=Vt.div``,go=Vt.div`
  margin-bottom: 16px;
...
`,bo=Vt.span`
  font-size: 1rem;
  color: var(--primary-text-color);
`;class wo extends HTMLElement{set hass(e){this._hass=e,this._render()}setConfig(e){var t,n,r,o,i,a;this._config=Object.assign(Object.assign({},e),{title:null!==(t=e.title)&&void 0!==t?t:"Chore Scheduler",show_disabled:null===(n=e.show_disabled)||void 0===n||n,show_next_due:null===(r=e.show_next_due)||void 0===r||r,default_mode:null!==(o=e.default_mode)&&void 0!==o?o:"display",show_completed:null!==(i=e.show_completed)&&void 0!==i&&i,enable_animations:null===(a=e.enable_animations)||void 0===a||a}),this._render()}connectedCallback(){this._teardown(),this._render()}disconnectedCallback(){this._teardown()}getCardSize(){return 3}static getConfigElement(){return document.createElement("chore-scheduler-card-editor")}static getStubConfig(){return{title:"Chore Scheduler",show_disabled:!0,show_next_due:!0,default_mode:"display",show_completed:!1,enable_animations:!0}}_teardown(){this._card&&(0,r.XX)(null,this._card),this._card=void 0,this.innerHTML=""}_ensureCard(){return this._card||(this._card=document.createElement("ha-card"),this.appendChild(this._card)),this._card}_render(){if(!this._config||!this._hass)return;const e=this._ensureCard();(0,r.XX)(i(It,{target:this,children:i(ho,{hass:this._hass,config:this._config})}),e)}}customElements.define("chore-scheduler-card",wo);class xo extends HTMLElement{constructor(){super(...arguments),this._handleConfigChanged=e=>{this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0})),this._render()}}set hass(e){this._hass=e,this._render()}setConfig(e){this._config=e,this._render()}_ensureContainer(){return this._container||(this._container=document.createElement("div"),this.appendChild(this._container)),this._container}_render(){if(!this._config||!this._hass)return;const e=this._ensureContainer();(0,r.XX)(i(It,{target:this,children:i(_o,{hass:this._hass,config:this._config,onConfigChanged:this._handleConfigChanged})}),e)}}customElements.define("chore-scheduler-card-editor",xo),window.customCards=window.customCards||[],window.customCards.push({type:"chore-scheduler-card",name:"Chore Scheduler Card",description:"A card for managing household chore schedules",preview:!0})})();