...
`;const _e={en:{"card.title":"Chore scheduler","card.empty_title":"No chores configured yet.","card.empty_subtitle":"Click the + button to add your first chore.","editor.add_title":"Add chore","editor.edit_title":"Edit chore","editor.name":"Name","editor.description":"Description (optional)","editor.enabled":"Enabled","editor.save":"Save","editor.add":"Add","editor.cancel":"Cancel","editor.delete":"Delete","editor.delete_confirm":"Are you sure you want to delete this chore?","schedule.title":"Schedule","schedule.frequency":"Frequency","schedule.once":"Once","schedule.daily":"Daily","schedule.weekly":"Weekly","schedule.monthly":"Monthly","schedule.days":"Days","schedule.day_of_month":"Day of month","schedule.time":"Time","weekday.monday":"Mon","weekday.tuesday":"Tue","weekday.wednesday":"Wed","weekday.thursday":"Thu","weekday.friday":"Fri","weekday.saturday":"Sat","weekday.sunday":"Sun","assignment.title":"Assignment","assignment.mode":"Mode","assignment.unassigned":"Unassigned","assignment.fixed":"Fixed","assignment.rotating":"Rotating","assignment.assignees":"Assignees","assignment.add_assignee":"Add assignee","assignment.rotating_current":"Rotating (current: {name})","assignment.assigned_to":"Assigned to: {names}","target.title":"Target","target.todo_list":"Todo list","target.default":"Default","notifications.title":"Notifications","notifications.send":"Send notifications","notifications.targets":"Notify targets","notifications.add_target":"Add target","display.daily_at":"Daily at {time}","display.monthly_at":"Monthly on day {day} at {time}","display.at_time":"At {time}"},sv:{"card.title":"Sysslor","card.empty_title":"Inga sysslor konfigurerade ännu.","card.empty_subtitle":"Klicka på + för att lägga till din första syssla.","editor.add_title":"Lägg till syssla","editor.edit_title":"Redigera syssla","editor.name":"Namn","editor.description":"Beskrivning (valfritt)","editor.enabled":"Aktiverad","editor.save":"Spara","editor.add":"Lägg till","editor.cancel":"Avbryt","editor.delete":"Ta bort","editor.delete_confirm":"Är du säker på att du vill ta bort denna syssla?","schedule.title":"Schema","schedule.frequency":"Frekvens","schedule.once":"En gång","schedule.daily":"Dagligen","schedule.weekly":"Veckovis","schedule.monthly":"Månadsvis","schedule.days":"Dagar","schedule.day_of_month":"Dag i månaden","schedule.time":"Tid","weekday.monday":"Mån","weekday.tuesday":"Tis","weekday.wednesday":"Ons","weekday.thursday":"Tor","weekday.friday":"Fre","weekday.saturday":"Lör","weekday.sunday":"Sön","assignment.title":"Tilldelning","assignment.mode":"Läge","assignment.unassigned":"Ej tilldelad","assignment.fixed":"Fast","assignment.rotating":"Roterande","assignment.assignees":"Tilldelade","assignment.add_assignee":"Lägg till person","assignment.rotating_current":"Roterande (nuvarande: {name})","assignment.assigned_to":"Tilldelad: {names}","target.title":"Mål","target.todo_list":"Att-göra-lista","target.default":"Standard","notifications.title":"Notifieringar","notifications.send":"Skicka notifieringar","notifications.targets":"Notifieringsmål","notifications.add_target":"Lägg till mål","display.daily_at":"Dagligen kl {time}","display.monthly_at":"Månadsvis dag {day} kl {time}","display.at_time":"Kl {time}"}};function ye(e,t,i){let s=(_e[t?.language||"en"]||_e.en)[e]||_e.en[e]||e;return i&&Object.entries(i).forEach(([e,t])=>{s=s.replace(`{${e}}`,String(t))}),s}function me(e,t){return ye(`weekday.${e}`,t)}const fe=["monday","tuesday","wednesday","thursday","friday","saturday","sunday"];let ve=class extends ne{constructor(){super(...arguments),this.chore=null,this._name="",this._description="",this._scheduleType="weekly",this._scheduleDays=["sunday"],this._scheduleTime="10:00",this._scheduleDayOfMonth=1,this._scheduleDate="",this._selectedAssignee=null,this._targetTodoList="",this._notificationsEnabled=!1,this._notifyTargets=[],this._persistentNotification=!1}firstUpdated(e){super.firstUpdated(e),this._initializeFromChore()}updated(e){super.updated(e),e.has("chore")&&this._initializeFromChore()}_initializeFromChore(){if(this.chore){this._name=this.chore.name,this._description=this.chore.description||"",this._scheduleType=this.chore.schedule.type,this._scheduleDays=this.chore.schedule.days||["sunday"],this._scheduleTime=this.chore.schedule.time||"10:00",this._scheduleDayOfMonth=this.chore.schedule.day_of_month||1,this._scheduleDate=this.chore.schedule.date||this._getTodayDate();const e=this.chore.assignment;"unassigned"!==e.mode&&e.assignees?.length?this._selectedAssignee=e.assignees[0]:this._selectedAssignee=null,this._targetTodoList=this.chore.target_todo_list||"",this._notificationsEnabled=this.chore.notifications.enabled,this._notifyTargets=[...this.chore.notifications.notify_targets||[]],this._persistentNotification=this._notifyTargets.includes("persistent_notification"),this._notifyTargets=this._notifyTargets.filter(e=>"persistent_notification"!==e)}else this._resetForm()}_resetForm(){this._name="",this._description="",this._scheduleType="weekly",this._scheduleDays=["sunday"],this._scheduleTime="10:00",this._scheduleDayOfMonth=1,this._scheduleDate=this._getTodayDate(),this._selectedAssignee=null,this._targetTodoList="",this._notificationsEnabled=!1,this._notifyTargets=[],this._persistentNotification=!1}_getTodayDate(){return(new Date).toISOString().split("T")[0]}render(){const e=!this.chore,t=this._getPersonEntities(),i=this._getMobileDevices();return q`
  ...
  `,e([pe({attribute:!1})],be.prototype,"hass",void 0),e([ue()],be.prototype,"_config",void 0),be=e([ce("chore-scheduler-card-editor")],be);const $e="chore_scheduler";let xe=class extends ne{constructor(){super(...arguments),this._chores=[],this._loading=!0,this._editingChore=null,this._showEditor=!1}setConfig(e){this._config={...e,title:e.title??"Chore Scheduler",show_disabled:e.show_disabled??!0,show_next_due:e.show_next_due??!0}}getCardSize(){return Math.max(3,this._chores.length+1)}firstUpdated(e){super.firstUpdated(e),this._loadChores()}updated(e){if(super.updated(e),e.has("hass")&&this.hass){e.get("hass")||this._loadChores()}}async _loadChores(){if(this.hass){this._loading=!0;try{console.log("[ChoreScheduler] Loading chores via WebSocket...");const e=await this.hass.connection.sendMessagePromise({type:"chore_scheduler/list"});console.log("[ChoreScheduler] WebSocket response:",e),this._chores=e?.chores??[]}catch(e){console.log("[ChoreScheduler] WebSocket failed:",e);try{const e=this.hass.states["sensor.chore_scheduler_next_chore"];console.log("[ChoreScheduler] Trying sensor fallback:",e),this._chores=e?.attributes?.chores?e.attributes.chores:[]}catch{this._chores=[]}}finally{this._loading=!1}}}render(){if(!this._config)return F;const e=this._config.show_disabled?this._chores:this._chores.filter(e=>e.enabled);return q`
    ...
    `}_formatSchedule(e){const t=e.time||"10:00";switch(e.type){case"once":{const i=e.date;if(i){return`${new Date(i+"T00:00:00").toLocaleDateString(this.hass?.language||"en",{month:"short",day:"numeric"})} ${t}`}return ye("display.at_time",this.hass,{time:t})}case"daily":return ye("display.daily_at",this.hass,{time:t});case"weekly":{const i=(e.days||["sunday"]).map(e=>me(e,this.hass)).join(", ");return`${i} ${t}`}case"monthly":return ye("display.monthly_at",this.hass,{day:e.day_of_month||1,time:t});default:return ye("display.at_time",this.hass,{time:t})}}_formatAssignment(e){if("unassigned"===e.mode||!e.assignees?.length)return"";const t=e.assignees.filter(e=>null!=e).map(e=>e.split(".").pop()?.replace(/_/g," ")||e);if(!t.length)return"";if("rotating"===e.mode){const i=t[e.current_index||0]||t[0];return ye("assignment.rotating_current",this.hass,{name:i})}return ye("assignment.assigned_to",this.hass,{names:t.join(", ")})}_addChore(){this._editingChore=null,this._showEditor=!0}_editChore(e){this._editingChore=e,this._showEditor=!0}_closeEditor(){this._showEditor=!1,this._editingChore=null}async _triggerChore(e,t){e.stopPropagation();try{await this.hass.callService($e,"trigger_chore",{chore_id:t.id})}catch(e){console.error("Error triggering chore:",e)}}async _handleChoreSave(e){const{chore:t,isNew:i}=e.detail;console.log("[ChoreScheduler] Saving chore:",{chore:t,isNew:i});try{i?(console.log("[ChoreScheduler] Calling add_chore service..."),await this.hass.callService($e,"add_chore",t),console.log("[ChoreScheduler] add_chore service completed")):(console.log("[ChoreScheduler] Calling update_chore service..."),await this.hass.callService($e,"update_chore",{chore_id:t.id,...t}),console.log("[ChoreScheduler] update_chore service completed")),this._closeEditor(),console.log("[ChoreScheduler] Reloading chores..."),await this._loadChores(),console.log("[ChoreScheduler] Chores reloaded:",this._chores)}catch(e){console.error("[ChoreScheduler] Error saving chore:",e),alert(`Failed to save chore: ${e instanceof Error?e.message:String(e)}`)}}async _handleChoreDelete(e){const{choreId:t}=e.detail;try{await this.hass.callService($e,"delete_chore",{chore_id:t}),this._closeEditor(),setTimeout(()=>this._loadChores(),500)}catch(e){console.error("Error deleting chore:",e)}}static getConfigElement(){return document.createElement("chore-scheduler-card-editor")}static getStubConfig(){return{title:"Chore Scheduler",show_disabled:!0,show_next_due:!0}}};xe.styles=ge,e([pe({attribute:!1})],xe.prototype,"hass",void 0),e([ue()],xe.prototype,"_config",void 0),e([ue()],xe.prototype,"_chores",void 0),e([ue()],xe.prototype,"_loading",void 0),e([ue()],xe.prototype,"_editingChore",void 0),e([ue()],xe.prototype,"_showEditor",void 0),xe=e([ce("chore-scheduler-card")],xe),window.customCards=window.customCards||[],window.customCards.push({type:"chore-scheduler-card",name:"Chore Scheduler Card",description:"A card for managing household chore schedules",preview:!0});export{xe as ChoreSchedulerCard};
